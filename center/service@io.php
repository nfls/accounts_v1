<?php require "components/Head_material.php" ?>
   ...
   <!-- page content -->
    ...
    <li class="tab col s3"><a href="#test-swipe-5">Test 5</a></li>
  </ul>
...
<!----------------end of tab 1------------------------- -->
  ...
  <div id="test-swipe-2" class="col s12 ">Test 2
<!----------------tab 2------------------------- -->
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
...
<!----------------end of tab 3------------------------- -->
  ...
  <div id="test-swipe-4" class="col s12 ">Test 4
<!-----------------------tab 4------------------------- -->
...
<!-------------------end of tab 4------------------------- -->
          ...
          <div id="test-swipe-5" class="col s12 ">Test 5
<!-----------------------tab 5------------------------- -->
